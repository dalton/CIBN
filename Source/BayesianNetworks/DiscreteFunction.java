...
public class DiscreteFunction {
  public DiscreteVariable variables[];
  public double values[];
  public DiscreteVariable ajk[];
  ...
  public DiscreteFunction(int n_vb, int n_vl, int n_ajk) {
	    variables = new DiscreteVariable[n_vb];
	    values = new double[n_vl];
	    ajk = new DiscreteVariable[n_ajk];
	  }
  /**
   * Simple constructor for DiscreteFunction.  
  ...
  public DiscreteFunction(DiscreteVariable pvs[], double v[], DiscreteVariable a_jk[]) {
	    variables = pvs;
	    values = v;
	    ajk = a_jk;
	  }
...
public DiscreteFunction multiply(DiscreteVariable dvs[], DiscreteFunction mult) {
  ...
  public void print(PrintStream out) {
    ...
    if (ajk != null){
    	...
    	for(int i =1 ; i<ajk.length; i++){
    		out.print(" \"" + ajk[i].name + "\" ");
    	}
    	out.print(") ");
    }
  ...
  public void set_variables(DiscreteVariable[] dv) {
	    variables = dv;
	  }

public DiscreteVariable[] getAjk() {
	return ajk;
}

public void setAjk(DiscreteVariable[] ajk) {
	this.ajk = ajk;
}
}
