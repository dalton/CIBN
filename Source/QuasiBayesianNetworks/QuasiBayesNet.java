...
public class QuasiBayesNet extends BayesNet {
  ...
  /***************************************************************/
  public QuasiBayesNet(BayesNet b_n) {
    super(b_n);
    bn = b_n;
    if (b_n instanceof QuasiBayesNet) {
        global_neighborhood_type = ((QuasiBayesNet)b_n).global_neighborhood_type;
        global_neighborhood_parameter = ((QuasiBayesNet)b_n).global_neighborhood_parameter;
    }
  }
